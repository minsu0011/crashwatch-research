...
# Historical peer/network descriptors whose names contain ``lead_``.  These
# are lagged relationship features from the sealed 439-feature universe, not
# forward target columns, and already passed the upstream leakage audit.
