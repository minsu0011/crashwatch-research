...
# Seal CUDA and native thread pools before importing NumPy/model libraries.
# Worker processes inherit these values from the supervisor, but doing this in
# the entry point also protects direct worker invocations.
