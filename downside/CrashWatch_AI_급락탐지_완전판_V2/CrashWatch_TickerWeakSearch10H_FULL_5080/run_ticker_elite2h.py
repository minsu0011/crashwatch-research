...
# Configure CUDA/native pools before NumPy and model libraries are imported.
if os.environ.get("CRASHWATCH_EXECUTION_PROFILE", "full").strip().lower() == "full":
...
def main() -> int:
    parser = argparse.ArgumentParser(description="CrashWatch weak-model 10-hour full-load search")
