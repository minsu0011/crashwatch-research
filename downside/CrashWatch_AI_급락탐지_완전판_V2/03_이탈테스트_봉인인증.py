...
USE_GPU = os.getenv("CRASHWATCH_USE_GPU", "0").strip().lower() in {"1", "true", "yes"}
N_THREADS = int(os.getenv("CRASHWATCH_N_THREADS", str(max(1, min(8, os.cpu_count() or 4)))) )
...
XGB_PARAMS = {
    "n_estimators": int(os.getenv("CRASHWATCH_XGB_ESTIMATORS", "700")),
    "max_depth": 7,
    "learning_rate": 0.04,
    "min_child_weight": 5,
    "subsample": 0.85,
